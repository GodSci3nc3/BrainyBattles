package com.example.brainy_bat.Adapter
...
import com.example.brainybattles2.databinding.ViewholderQuizBinding
...
class QuestionAdapter (
    ...
    private lateinit var binding: ViewholderQuizBinding
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuestionAdapter.Viewholder {
      val inflater=LayoutInflater.from(parent.context)
        binding=ViewholderQuizBinding.inflate(inflater,parent,false)
        return Viewholder()
    }

    override fun onBindViewHolder(holder: QuestionAdapter.Viewholder, position: Int) {
        val binding = ViewholderQuizBinding.bind(holder.itemView)
